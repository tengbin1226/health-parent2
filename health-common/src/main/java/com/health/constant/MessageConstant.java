...
public class MessageConstant {
    ...
    public static final String GET_MENUBYID_SUCCESS = "获取指定菜单信息成功";
    public static final String GET_MENUBYID_FAIL = "获取指定菜单信息失败";

    public static final String GET_UPDATEMENU_SUCCESS = "修改指定菜单信息成功";
    public static final String GET_UPDATEMENU_FAIL = "修改指定菜单信息失败";

    public static final String GET_ADDMENU_SUCCESS = "添加菜单信息成功";
    public static final String GET_ADDMENU_FAIL = "添加菜单信息失败";
